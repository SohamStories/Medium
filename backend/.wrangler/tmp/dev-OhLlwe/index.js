...
// .wrangler/tmp/bundle-FNyh81/checked-fetch.js
...
var require_edge = __commonJS({
  "node_modules/@prisma/client/runtime/edge.js"(exports, module) {
    ...
    var Wi = Fe((wh, Xa) => {
      Xa.exports = { name: "@prisma/engines-version", version: "5.17.0-31.393aa359c9ad4a4bb28630fb5613f9c281cde053", main: "index.js", types: "index.d.ts", license: "Apache-2.0", author: "Tim Suchanek <suchanek@prisma.io>", prisma: { enginesVersion: "393aa359c9ad4a4bb28630fb5613f9c281cde053" }, repository: { type: "git", url: "https://github.com/prisma/engines-wrapper.git", directory: "packages/engines-version" }, devDependencies: { "@types/node": "18.19.34", typescript: "4.9.5" }, files: ["index.js", "index.d.ts"], scripts: { build: "tsc -d" } };
    });
    var Ki = Fe(() => {
      "use strict";
      f();
...
To solve this, provide the connection string directly: https://pris.ly/d/cloudflare-datasource-url`, n) : new J(`error: Environment variable not found: ${s.fromEnvVar}.`, n);
    ...
    m();
    d();
    var rs = { "@prisma/debug": "workspace:*", "@prisma/engines-version": "5.17.0-31.393aa359c9ad4a4bb28630fb5613f9c281cde053", "@prisma/fetch-engine": "workspace:*", "@prisma/get-platform": "workspace:*" };
    f();
    c();
    p();
    m();
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\Asus\\Desktop\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "inlineSchemaHash": "7597efd7f9d536d6668a1db55cf2268774b58fe77308c5ecbb2a97c5645798a9",
      "copyEngine": false
    };
    config.dirname = "/";
...
// .wrangler/tmp/bundle-FNyh81/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-FNyh81/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
app.put("/api/v1/blog", (c) => {
  return c.text("PUT THIS BLOG ");
});
app.get("/api/v1/blog/:id", (c) => {
  const id = c.req.param("id");
  console.log(id);
  return c.text("GIVE ME THAT BLOG  ");
});
